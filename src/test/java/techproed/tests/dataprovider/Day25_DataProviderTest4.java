...
//    Bu ornekte, data provider metodumuz Util classdan gelecek
...
//    musteriHizmetleriVerileri
    ...
    public void musteriHizmetleriVerileriTest(String username,String password,String sube){
        System.out.println(username+"  |  "+password);
    }

//    personelVerileri
    @Test(dataProvider = "personelVerileri", dataProviderClass = DataProviderUtils.class)
    public void personelVerileriTest(String username,String password,String sube){
        System.out.println(username+"  |  "+password);
    }
